...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_profile'])) {
    ...
    $check_stmt->execute();
    $total_users = $check_stmt->get_result()->fetch_assoc()['total'];
    $check_stmt->close();

    if ($total_users <= 1) {
        $error = "Impossible de supprimer le compte. Il doit y avoir au moins un utilisateur sur la plateforme.";
    } else {
        ...
        <form method="POST" action="" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-md-4 text-center mb-4">
              ...
              <input type="file" enctype="multipart/form-data" class="d-none" id="profilePicture" name="profilePicture" accept="image/*" onchange="previewProfilePhoto(event)" />
